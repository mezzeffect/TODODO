...
using System;
using TodoSampleMobile.UITest.Screens.Login;
	...
	public static class AppInitializer
	{
		...
		public static void InitializeScreens(Platform platform)
		{
			if (platform == Platform.iOS) {
				...
				FeatureContext.Current.Add (ScreenNames.Login, new iOSLoginScreen()); 
			} else if (platform == Platform.Android) {
				FeatureContext.Current.Add (ScreenNames.Home, new AndroidHomeScreen ());
				FeatureContext.Current.Add (ScreenNames.Login, new AndroidLoginScreen());
			}
		}
	}
}